...
### 1. Reverting Commits (`git2/revert.h`)
...
### 2. Pointer Resetting (`git2/reset.h`)
...
### 3. Git Settings Portal (`git2/config.h`)
...
### 4. Submodule Management (`git2/submodule.h`)
...
### 6. Worktree Support (`git2/worktree.h`)
...
### 8. Reflog Navigation (`git2/reflog.h`)
...
### 9. Tag Creation (Annotated & Lightweight) (`git2/tag.h`)
...
### 10. Remote Repository CRUD & Refspecs (`git2/remote.h`)
...
### 11. Ahead/Behind Graph Analysis (`git2/graph.h`)
...
### 12. 3-Way Conflict Resolution & Staged Conflict Removal (`git2/index.h` & `git2/merge.h`)
...
### 13. Commit Amending & GPG/SSH Signature Signing (`git2/commit.h` & `git2/sys/commit.h`)
...
### 14. Stash Advanced Options & Patch Inspection (`git2/stash.h`)
...
### 15. Git Describe (`git2/describe.h`)
...
### 16. Ignore Rules Integration (`git2/ignore.h`)
...
### 17. Git Notes Management (`git2/note.h`)
...
### 18. Revision Parsing Engine (`git2/revparse.h`)
...
### 19. Clean Workspace (`git clean`) (`git2/status.h`)
...
### 20. Mailmap Support (`git2/mailmap.h`)
