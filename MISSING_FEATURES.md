...
### 5. Tag Creation (Annotated & Lightweight) (`git2/tag.h`)
...
### 6. Remote Repository CRUD & Refspecs (`git2/remote.h`)
...
### 7. Ahead/Behind Graph Analysis (`git2/graph.h`)
...
### 8. Commit Amending & GPG/SSH Signature Signing (`git2/commit.h` & `git2/sys/commit.h`)
...
### 9. Stash Advanced Options & Patch Inspection (`git2/stash.h`)
...
### 10. Git Describe (`git2/describe.h`)
...
### 11. Ignore Rules Integration (`git2/ignore.h`)
...
### 12. Git Notes Management (`git2/note.h`)
...
### 13. Revision Parsing Engine (`git2/revparse.h`)
...
### 14. Clean Workspace (`git clean`) (`git2/status.h`)
...
### 15. Mailmap Support (`git2/mailmap.h`)
