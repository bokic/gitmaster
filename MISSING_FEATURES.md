...
### 1. Pointer Resetting (`git2/reset.h`)
...
### 2. Git Settings Portal (`git2/config.h`)
...
### 3. Submodule Management (`git2/submodule.h`)
...
### 5. Worktree Support (`git2/worktree.h`)
...
### 7. Reflog Navigation (`git2/reflog.h`)
...
### 8. Tag Creation (Annotated & Lightweight) (`git2/tag.h`)
...
### 9. Remote Repository CRUD & Refspecs (`git2/remote.h`)
...
### 10. Ahead/Behind Graph Analysis (`git2/graph.h`)
...
### 11. 3-Way Conflict Resolution & Staged Conflict Removal (`git2/index.h` & `git2/merge.h`)
...
### 12. Commit Amending & GPG/SSH Signature Signing (`git2/commit.h` & `git2/sys/commit.h`)
...
### 13. Stash Advanced Options & Patch Inspection (`git2/stash.h`)
...
### 14. Git Describe (`git2/describe.h`)
...
### 15. Ignore Rules Integration (`git2/ignore.h`)
...
### 16. Git Notes Management (`git2/note.h`)
...
### 17. Revision Parsing Engine (`git2/revparse.h`)
...
### 18. Clean Workspace (`git clean`) (`git2/status.h`)
...
### 19. Mailmap Support (`git2/mailmap.h`)
