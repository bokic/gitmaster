...
### 1. Submodule Management (`git2/submodule.h`)
...
### 3. Worktree Support (`git2/worktree.h`)
...
### 5. Reflog Navigation (`git2/reflog.h`)
...
### 6. Tag Creation (Annotated & Lightweight) (`git2/tag.h`)
...
### 7. Remote Repository CRUD & Refspecs (`git2/remote.h`)
...
### 8. Ahead/Behind Graph Analysis (`git2/graph.h`)
