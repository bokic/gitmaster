...
signals:
    ...
    void repositoryCherrypick(const QString &commitId);
    void repositoryRevert(const QString &commitId);
    void repositoryReset(const QString &commitId, git_reset_t type);
...
private:
    ...
    QList<QGitSubmodule> m_submodules;
